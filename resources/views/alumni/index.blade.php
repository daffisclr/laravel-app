@extends('alumni.alumni_dashboard')
@section('alumni')
                            ...
                            <div class="card top-selling overflow-auto">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{ url('backend/assets/img/product-1.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{ url('backend/assets/img/product-2.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{ url('backend/assets/img/product-3.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{ url('backend/assets/img/product-4.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img src="{{ url('backend/assets/img/product-5.jpg') }}"
                                                            alt=""></a></th>
